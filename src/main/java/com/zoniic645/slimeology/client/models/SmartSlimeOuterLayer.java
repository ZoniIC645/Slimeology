...
public class SmartSlimeOuterLayer<T extends SmartSlimeEntity> extends RenderLayer<T, SmartSlimeEntityModel<T>>{
	private final SmartSlimeEntityModel<T> model;

	public SmartSlimeOuterLayer(RenderLayerParent<T, SmartSlimeEntityModel<T>> pRenderer, EntityModelSet pModelSet){
		super(pRenderer);
		this.model = new SmartSlimeEntityModel<>(pModelSet.bakeLayer(ModModelLayers.SMART_SLIME_OUTER_LAYER));
	}
